function adCreate(taskJson, deletable = false) {
    ...
    <div class = "${contClass}">
        ...
        <button class="${btnClass}" style="color:green;float:right;vertical-align:text-top;font-size: 1.2em;top:-100px;text-decoration:none !important;;" onclick="adComplete(this)">✓</button>\n`
                  : `\n`)
        +
