function adCreate(taskJson, deletable = false) {
    ...
    <div class = "${contClass}">
        ...
        <button class="${btnClass}" style="float:right;vertical-align:text-top;font-size: 1.2em;top:-100px;text-decoration:none !important;color:#F83939 !important;" onclick="adComplete(this)">✓</button>\n`
                  : `\n`)
        +
